...
CAMPSITES = {'259309': 'Lewis Lake, Yellowstone NP'}
...
for campsite_id, campsite_name in CAMPSITES.items():
  with urllib.request.urlopen(
    ...
    for id, entry in dates_available_for_sites.items():
      ...
      line = (f"Campsite '{site}' in loop {loop} at {CAMPSITES[campsite_id]} is available for night of {formatted_times}. ({site_url})")
